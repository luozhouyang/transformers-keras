...
class _QuestionAnsweringXDatasetTransform:
...
class QuestionAnsweringXDataset:
        ...
        **kwargs
        ...
        Args:
            ...
            fn: A callable to parse line to examples.
                It's signature is: def fn(instance, **kwargs) -> List[QuestionAnsweringXExample],
    ...
    @classmethod
    def _read_jsonl_examples(cls, input_files, fn, **kwargs) -> List[QuestionAnsweringXExample]:
        all_examples = []
