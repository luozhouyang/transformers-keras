...
class QuestionAnsweringTokenizer(abc.ABC):
    """Tokenizer for token classification tasks."""
...
class QuestionAnsweringTokenizerForChinese(QuestionAnsweringTokenizer):
    """Chinese tokenizer for token classification tasks."""
