...
class BertAdapter(AbstractAdapter):
    ...
    def adapte_weights(self, model, ckpt, model_config, use_functional_api=True, **kwargs):
        ...
        weight_mapping = {}
        bert_weight_mapping = self._adapte_bert_weights(
        ...
        nsp_weight_mapping = self._adapte_nsp_weights(
            model, ckpt, self_weight_names, ckpt_weight_names, use_functional_api=use_functional_api, **kwargs
        )
    ...
    def _adapte_bert_weights(self, model, ckpt, self_weight_names, ckpt_weight_names, use_functional_api=True, **kwargs):
    ...
    def _adapte_nsp_weights(self, model, ckpt, self_weight_names, ckpt_weight_names, use_functional_api=True, **kwargs):
